      ...
      <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        <li class="dropdown-menu-header">
          <div class="dropdown-header d-flex">
            ...
            <div class="badge rounded-pill badge-light-primary">5 Novas</div>
          </div>
        </li>
    ...
    <li class="nav-item dropdown dropdown-user">
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <div class="user-nav d-sm-flex d-none">
          ...
          <span class="user-name fw-bolder">{{  strtok(Auth::user()->name, " ") }}</span>
          <span class="user-status">{{ Auth::user()->admin ? 'Admin' : 'Membro' }}</span>
        </div>
        <span class="avatar">
          <img class="round"
            src="{{ asset('/images/avatars/' . Auth::user()->profile_picture) }}" alt="Foto de Perfil" height="40" width="40">
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
        ...
        @if (Auth::check())
          ...
          <form method="POST" id="logout-form" action="{{ route('login') }}">
            @csrf
          </form>
        @else
